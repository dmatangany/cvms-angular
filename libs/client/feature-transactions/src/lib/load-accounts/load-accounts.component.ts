...
@Component({
  selector: 'membership-application-load-accounts',
  templateUrl: './load-accounts.component.html',
  styleUrls: ['./load-accounts.component.scss'],
})
export class LoadAccountsComponent implements OnInit {
