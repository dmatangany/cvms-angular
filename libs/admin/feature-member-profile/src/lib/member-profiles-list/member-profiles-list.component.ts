...
@Component({
  selector: 'membership-application-member-profiles-list',
  templateUrl: './member-profiles-list.component.html',
  styleUrls: ['./member-profiles-list.component.css'],
})
export class MemberProfilesListComponent implements OnInit, AfterViewChecked {
  public isEdit = false;
